    ...
    <ScrollView className="grid">
        <View className='flex-row justify-between items-center p-3'>
            ...
            <View className='flex-row gap-x-2 items-center'>
                ...
                <Feather name='edit-2' className='items-center' color={'#A5A1A1'} size={20} />

            </View>


        </View>
        <View className='bg-[#F0EFEF] mt-2 w-full h-[1px] '>

        </View>
        <View className="items-center flex-row  bg-white mt-5 mx-auto w-full justify-between ">
        <View className="grid items-center   gap-2">
          <Image source={internet} className="h-[24px] w-[24px] relative   items-center  " />
          <Text className='font-[500] text-center '>Internet</Text>
        </View>

        <View className="grid items-center   gap-2">
          <Image source={school} className="h-[24px] w-[24px] relative   items-center  " />
          <Text className='font-[500] text-center '>Tution</Text>
        </View>

        <View className="grid items-center   gap-2">
          <Image source={electricity} className="h-[24px] w-[24px] relative   items-center  " />
          <Text className='font-[500] text-center '>electricity</Text>
        </View>

        <View className="grid items-center   gap-2">
          <Image source={more} className="h-[24px] w-[24px] relative   items-center  " />
